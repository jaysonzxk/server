...
class MemberInitSerializer(CustomModelSerializer):
    """
...
class MemberCreateSerializer(CustomModelSerializer):
    """
    用户新增-序列化器
    """
...
class MemberUpdateSerializer(CustomModelSerializer):
    """
    用户修改-序列化器
    """
...
class MemberInfoUpdateSerializer(CustomModelSerializer):
    """
    会员修改-序列化器
    """
    mobile = serializers.CharField(
...
class ExportMemberProfileSerializer(CustomModelSerializer):
    """
    会员导出 序列化器
    """
...
class MemberViewSet(CustomModelViewSet):
    ...
    queryset = Users.objects.exclude(is_superuser=1).filter(user_type=1).all()
    serializer_class = MemberSerializer
    create_serializer_class = MemberCreateSerializer
    update_serializer_class = MemberUpdateSerializer
    ...
    export_serializer_class = ExportMemberProfileSerializer
    # 导入
    ...
    def update_user_info(self, request):
        """修改当前用户信息"""
        serializer = MemberInfoUpdateSerializer(request.user, data=request.data, request=request)
