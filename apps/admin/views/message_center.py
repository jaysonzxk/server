...
from apps.admin.models import MessageCenter, Users, MessageCenterTargetUser
from apps.utils.json_response import SuccessResponse, DetailResponse
...
class MessageCenterSerializer(CustomModelSerializer):
    ...
    def get_dept_info(self, instance, parsed_query):
        ...
        # You can do what ever you want in here
        # `parsed_query` param is passed to BookSerializer to allow further querying
        from apps.admin.views.dept import DeptSerializer
    ...
    def save(self, **kwargs):
        ...
        for user in users:
            ...
            if target_type in [1,2]:
                ...
                websocket_push(room_name, message={"sender": 'admin', "contentType": 'SYSTEM',
                                                   "content": '您有一条新消息~', "refresh_unread": True})
...
class MessageCenterViewSet(CustomModelViewSet):
    ...
    def retrieve(self, request, *args, **kwargs):
        ...
        websocket_push(room_name, message={"sender": 'admin', "contentType": 'TEXT',
