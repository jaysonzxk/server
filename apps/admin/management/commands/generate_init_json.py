...
from apps.admin.views.system_config import SystemConfigInitSerializer
...
from apps.admin.models import Menu, Users, Dept, Role, ApiWhiteList, Dictionary, SystemConfig
from apps.admin.views.api_white_list import ApiWhiteListInitSerializer
from apps.admin.views.dept import DeptInitSerializer
from apps.admin.views.dictionary import DictionaryInitSerializer
from apps.admin.views.menu import MenuInitSerializer
from apps.admin.views.role import RoleInitSerializer
from apps.admin.views.user import UsersInitSerializer
