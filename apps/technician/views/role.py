...
from apps.admin.models import Role, Menu, MenuButton, Dept
from apps.admin.views.dept import DeptSerializer
from apps.admin.views.menu import MenuSerializer
from apps.admin.views.menu_button import MenuButtonSerializer
